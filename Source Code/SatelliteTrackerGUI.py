...
class Window3D10(Qt3DExtras.Qt3DWindow):
    ...
    sat1 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[0]))[0]
    e, position1, v = sat1.sgp4(Time.now().jd1, Time.now().jd2)

    sat2 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[1]))[0]
    e, position2, v = sat2.sgp4(Time.now().jd1, Time.now().jd2)

    sat3 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[2]))[0]
    e, position3, v = sat3.sgp4(Time.now().jd1, Time.now().jd2)

    sat4 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[3]))[0]
    e, position4, v = sat4.sgp4(Time.now().jd1, Time.now().jd2)

    sat5 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[4]))[0]
    e, position5, v = sat5.sgp4(Time.now().jd1, Time.now().jd2)

    sat6 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[5]))[0]
    e, position6, v = sat6.sgp4(Time.now().jd1, Time.now().jd2)

    sat7 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[6]))[0]
    e, position7, v = sat7.sgp4(Time.now().jd1, Time.now().jd2)

    sat8 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[7]))[0]
    e, position8, v = sat8.sgp4(Time.now().jd1, Time.now().jd2)

    sat9 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[8]))[0]
    e, position9, v = sat9.sgp4(Time.now().jd1, Time.now().jd2)

    sat10 = list(CelestrakAPI.load_gp_from_celestrak(name=satnames[9]))[0]
    e, position10, v = sat10.sgp4(Time.now().jd1, Time.now().jd2)

    satlist = [sat1, sat2, sat3, sat4, sat5, sat6, sat7, sat8, sat9, sat10]

    def __init__(self):
        super().__init__()
        self.resize(300, 200)

        position1 = list(self.position1)
        position1 = [position1[i] / 1000 for i in range(3)]
        self.position1 = tuple(position1)

        position2 = list(self.position2)
        position2 = [position2[i] / 1000 for i in range(3)]
        self.position2 = tuple(position2)


        position3 = list(self.position3)
        position3 = [position3[i] / 1000 for i in range(3)]
        self.position3 = tuple(position3)

        position4 = list(self.position4)
        position4 = [position4[i] / 1000 for i in range(3)]
        self.position4 = tuple(position4)

        position5 = list(self.position5)
        position5 = [position5[i] / 1000 for i in range(3)]
        self.position5 = tuple(position5)

        position6 = list(self.position6)
        position6 = [position6[i] / 1000 for i in range(3)]
        self.position6 = tuple(position6)

        position7 = list(self.position7)
        position7 = [position7[i] / 1000 for i in range(3)]
        self.position7 = tuple(position7)

        position8 = list(self.position8)
        position8 = [position8[i] / 1000 for i in range(3)]
        self.position8 = tuple(position8)

        position9 = list(self.position9)
        position9 = [position9[i] / 1000 for i in range(3)]
        self.position9 = tuple(position9)

        position10 = list(self.position10)
        position10 = [position10[i] / 1000 for i in range(3)]
        self.position10 = tuple(position10)
    ...
    def createScene(self):
        ...
        self.sphereTransform1.setTranslation(QVector3D(self.position1[0], self.position1[1], self.position1[2]))
        ...
        self.sphereTransform2.setTranslation(QVector3D(self.position2[0], self.position2[1], self.position2[2]))
        ...
        self.sphereTransform3.setTranslation(QVector3D(self.position3[0], self.position3[1], self.position3[2]))
        ...
        self.sphereTransform4.setTranslation(QVector3D(self.position4[0], self.position4[1], self.position4[2]))
        ...
        self.sphereTransform5.setTranslation(QVector3D(self.position5[0], self.position5[1], self.position5[2]))
        ...
        self.sphereTransform6.setTranslation(QVector3D(self.position6[0], self.position6[1], self.position6[2]))
        ...
        self.sphereTransform7.setTranslation(QVector3D(self.position7[0], self.position7[1], self.position7[2]))
        ...
        self.sphereTransform8.setTranslation(QVector3D(self.position8[0], self.position8[1], self.position8[2]))
        ...
        self.sphereTransform9.setTranslation(QVector3D(self.position9[0], self.position9[1], self.position9[2]))
        ...
        self.sphereTransform10.setTranslation(QVector3D(self.position10[0], self.position10[1], self.position10[2]))
